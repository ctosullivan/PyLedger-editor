...
from ledgerkit_editor.highlighting import LedgerHighlighter, build_textarea_theme
from ledgerkit_editor.highlighting import tokens as _tok
...
class LedgerTextArea(TextArea):
    ...
    def _rebuild_ledger_theme(self) -> None:
        ...
        """
        from ledgerkit_editor.themes import TEXTAREA_THEME_MAP
